...
import { CheckBox, Input, Scroll } from "@alx-home/Utils";

const gridSize = 16;

const GridElem = ({ children, index, active, edit }: PropsWithChildren<{
   index: number
   active: boolean
   edit: boolean
}>) => {
   ...
   return <div className={"flex border-slate-700 p-2 grow h-16"
      ...
      + (col === 1 ? ' border-l-2' : '')
      + ((edit ? [2, 5, 9] : [2, 5, 8, 10]).find(i => i === col) ? " ml-2 border-l-2" : "")
      + ((index < gridSize2) ? ' border-t-2' : '')}
      style={{ gridColumn: col, gridRow: row }}>
      <div className={
         "flex justify-center m-auto w-full"
...
export const TabElem = ({ tab, currentTab, coords, edit, navData }: {
   ...
   const legs = useMemo(() => {
      ...
      return coords.map((_value, index) => {
         ...
         if (index === 0) {
            ...
            return [<GridElem key={"Waypoint"} index={index_} active={true} edit={edit}>
               {
                  edit ?
            ...
            result.push(<GridElem key={"Waypoint"} index={index_} active={true} edit={edit}>
               {
                  edit ?
            ...
            ++index_;
            result.push(<GridElem key={"Altitude"} index={index_} active={active} edit={edit}>
            ...
            ++index_;
            result.push(<GridElem key={"VOR"} index={index_} active={active} edit={edit}>
               {
                  edit ?
            ...
            result.push(<GridElem key={"OBS"} index={index_} active={active} edit={edit}>
            ...
            if (edit) {
               result.push(<GridElem key={"Wind"} index={index_} active={active} edit={edit}>
                  <div className="flex flex-row [&_.invalid]:text-red-500">
               ...
               ++index_;
               result.push(<GridElem key={"VAR"} index={index_} active={active} edit={edit}>
                  <div className="flex flex-row [&_.invalid]:text-red-500">
               ...
               ++index_;
               result.push(<GridElem key={"IAS"} index={index_} active={active} edit={edit}>
                  <div className="[&_.invalid]:text-red-500">
               ...
               ++index_;
               result.push(<GridElem key={"OAT"} index={index_} active={active} edit={edit}>
                  <div className="[&_.invalid]:text-red-500">
                     <Input active={true} className="w-16" onChange={(value) => {
                        navProps.oat = +value;
                        editNavProperties(id, properties);
               ...
               ++index_;
               result.push(<GridElem key={"ATA"} index={index_} active={active} edit={edit}>
                  <div className="[&_.invalid]:text-red-500">
               ...
               result.push(<GridElem key={"CH"} index={index_} active={active} edit={edit}>
                  <div className="w-16 m-auto text-center">{Math.round(CH).toString() + "\u00b0 "}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"MH"} index={index_} active={active} edit={edit}>
                  <div className="w-16 m-auto text-center">{Math.round(MH).toString() + "\u00b0 "}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"Dist"} index={index_} active={active} edit={edit}>
                  <div className="w-16 m-auto text-center">{Math.round(dist).toString()}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"TAS"} index={index_} active={active} edit={edit}>
                  <div className="w-16 m-auto text-center">{Math.round(tas)}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"GS"} index={index_} active={active} edit={edit}>
                  <div className="w-16 m-auto text-center">{Math.round(GS).toString()}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"ETE"} index={index_} active={active} edit={edit}>
                  <div className="m-auto text-center">{dur}</div>
               </GridElem>)
               ++index_;
               result.push(<GridElem key={"ETA"} index={index_} active={active} edit={edit}>
            ...
            result.push(<GridElem key={"Fuel"} index={index_} active={active} edit={edit}>
               {
                  edit ?
                     <div className="[&_.invalid]:text-red-500">
            ...
            ++index_;
            result.push(<GridElem key={"Remarks"} index={index_} active={active} edit={edit}>
               {
                  edit ?
            ...
            if (!edit) {
               ++index_;
               result.push(<GridElem key={"checkbox"} index={index_} active={active} edit={edit}>
   ...
   }, [actives, coords, departureTime, edit, editNavProperties, fromUnit, id, loadedFuel, properties, setActive, toUnit])

   return <div className={'flex flex-row text-xl [grid-row:1] [grid-column:1] overflow-hidden'
      ...
      <Scroll className={
         ...
         <div className='flex flex-col mx-5 shadow-sm w-full'>
            <div className={"grid pb-8"}>
               <GridElem index={0} active={true} edit={edit}>Waypoint</GridElem>
               <GridElem index={1} active={true} edit={edit}>Altitude</GridElem>
               <GridElem index={2} active={true} edit={edit}>VOR Ind/Freq</GridElem>
               <GridElem index={3} active={true} edit={edit}>OBS</GridElem>

               {edit ?
                  <>
                     <GridElem index={4} active={true} edit={edit}>Wind Dir/Vel</GridElem>
                     <GridElem index={5} active={true} edit={edit}>VAR</GridElem>
                     <GridElem index={6} active={true} edit={edit}>IAS</GridElem>
                     <GridElem index={7} active={true} edit={edit}>OAT</GridElem>
                     <GridElem index={8} active={true} edit={edit}>ATA</GridElem>
                  </>
                  : <>
                     <GridElem index={4} active={true} edit={edit}>CH</GridElem>
                     <GridElem index={5} active={true} edit={edit}>MH</GridElem>
                     <GridElem index={6} active={true} edit={edit}>Dist</GridElem>
                     <GridElem index={7} active={true} edit={edit}>TAS</GridElem>
                     <GridElem index={8} active={true} edit={edit}>GS</GridElem>
                     <GridElem index={9} active={true} edit={edit}>ETE</GridElem>
                     <GridElem index={10} active={true} edit={edit}>ETA</GridElem>
                  </>
               }
               <GridElem index={1 + (edit ? 8 : 10)} active={true} edit={edit}>Fuel ({fuelUnit === 'gal' ? 'gal' : 'l'})</GridElem>
               <GridElem index={2 + (edit ? 8 : 10)} active={true} edit={edit}>Remarks</GridElem>
               {legs}
            </div>
            {
               edit ?
            ...
            <div className="flex flex-col grow p-4 pt-12">
