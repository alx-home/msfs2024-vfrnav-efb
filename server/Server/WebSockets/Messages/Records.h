...
struct ActiveRecord : Header {
   ...
   static constexpr js::Proto PROTOTYPE{
     js::Extend{
       ...
       js::_{"__ACTIVE_RECORD__", &ActiveRecord::header_},

       js::_{"id", &ActiveRecord::id_},
       js::_{"active", &ActiveRecord::active_},
     },
   };
};
