 ...
 */
export declare class AppViewService {
    ...
    on(event: OnEvent, viewKey: string, callback: (view?: PublicUiViewEntry) => void): this;
    /**
...
export {};
//# sourceMappingURL=AppViewService.d.ts.map